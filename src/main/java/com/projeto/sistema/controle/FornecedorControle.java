...
public class FornecedorControle {
	...
	public ModelAndView editar(@PathVariable("id") Long id) { //@PathVariable vai capturar o valor de id e adicionar va variavel id
		Optional<Fornecedor> fornecedor = fornecedorRepositorio.findById(id); // Vai fazer a consulta, se exitir...
		return cadastrar(fornecedor.get()); // joga a parte do cadastro e fornece as informacoes para ser editadas. 
	}
